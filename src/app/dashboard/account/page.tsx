        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link
              ...
              className="flex items-center justify-between rounded-2xl border border-sky-100 dark:border-slate-800 bg-white dark:bg-blue-950 p-5 shadow-sm transition-colors hover:bg-sky-50 dark:hover:bg-slate-800"
            >
              <div>
                ...
                <p className="font-ui text-xs text-slate-400 dark:text-slate-500">
                  Manage the Gmail account connected to Stuff Tracker
                </p>
              </div>
              <span className="font-ui text-sm text-sky-600 dark:text-sky-400">
                Manage
              </span>
            </Link>
